    ...
    if ($action === 'install_sample') {
        ...
        $sampleMovies = array(
            array(
                ...
                'rating' => '8.8', 'duration' => '2h 28m', 'quality' => 'Demo',
            ...
            array(
                ...
                'rating' => '9.0', 'duration' => '2h 32m', 'quality' => 'Demo',
                'status' => 'published', 'trailer' => '', 'stream_url' => 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
            ...
            array(
                ...
                'rating' => '8.6', 'duration' => '2h 49m', 'quality' => 'Demo',
                'status' => 'published', 'trailer' => '', 'stream_url' => 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
            ...
            array(
                ...
                'rating' => '8.2', 'duration' => '2h 28m', 'quality' => 'Demo',
                'status' => 'published', 'trailer' => '', 'stream_url' => 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
            ...
            array(
                ...
                'rating' => '7.6', 'duration' => '3h 12m', 'quality' => 'Demo',
                'status' => 'published', 'trailer' => '', 'stream_url' => 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
        ...
        $samplePages = array(
            array(
                ...
                'content' => '<h1>About BDMovieHub</h1><p>BDMovieHub is a catalog for discovering Bangla movies, series, anime and related information. We list titles with accurate metadata and link to legal watch options where available.</p><h2>What We Offer</h2><ul><li>Accurate title information and release details</li><li>Genre and language browsing</li><li>Search across Bangla and English titles</li><li>Regular catalog updates</li></ul>',
