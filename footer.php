        ...
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <?php if (!isset($settings['enable_top10']) || !empty($settings['enable_top10'])): ?><li><a href="<?php e(BASE_URL); ?>/top10.php">Top 10 Charts</a></li><?php endif; ?>
                    <li><a href="<?php e(BASE_URL); ?>/top-rated.php">Top Rated</a></li>
                    <?php if (!isset($settings['enable_az']) || !empty($settings['enable_az'])): ?><li><a href="<?php e(BASE_URL); ?>/az.php">Browse A-Z</a></li><?php endif; ?>
                    <?php if (!isset($settings['enable_downloads']) || !empty($settings['enable_downloads'])): ?><li><a href="<?php e(BASE_URL); ?>/download.php">Download Center</a></li><?php endif; ?>
                    <li><a href="<?php e(BASE_URL); ?>/genres.php">Genres</a></li>
                    <?php if (!isset($settings['enable_tvguide']) || !empty($settings['enable_tvguide'])): ?><li><a href="<?php e(BASE_URL); ?>/tv-guide.php">TV Guide</a></li><?php endif; ?>
