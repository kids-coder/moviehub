...
$staticPages = array(
    ...
    array('loc' => $siteBase . '/top10.php', 'priority' => '0.8', 'freq' => 'daily'),
    array('loc' => $siteBase . '/az.php', 'priority' => '0.8', 'freq' => 'weekly'),
    array('loc' => $siteBase . '/tv-guide.php', 'priority' => '0.6', 'freq' => 'daily'),
    array('loc' => $siteBase . '/download.php', 'priority' => '0.6', 'freq' => 'weekly'),
