...
<head>
    ...
    <!-- SEO extras: hreflang + alternate discovery feeds -->
    <link rel="alternate" hreflang="en" href="<?php e($ogUrl); ?>">
    <link rel="alternate" hreflang="x-default" href="<?php e($ogUrl); ?>">
    <link rel="alternate" type="application/rss+xml" title="<?php e(isset($settings['site_name']) ? $settings['site_name'] : SITE_NAME); ?> RSS Feed" href="<?php e(BASE_URL); ?>/rss.xml">
    <link rel="sitemap" type="application/xml" href="<?php e(BASE_URL); ?>/sitemap.xml">
